                                    ...
                                    <c:forEach items="${sessionScope.productOrders}" var="productOrder">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                                                ...
                                                <form id="updateForm" action="updatequantityproductorder" method="GET">
                                                    <div class="d-flex mb-4" style="max-width: 300px; align-items: center;">
                                                        <button data-mdb-button-init data-mdb-ripple-init class="btn btn-danger px-3 me-2"
                                                                type="submit" name="action" value="decrease" onclick="this.parentNode.querySelector('input[type=number]').stepDown()">
                                                            <i class="fas fa-minus"></i>
                                                        </button>

                                                        <div data-mdb-input-init class="form-outline text-center">
                                                            <input id="form1" min="1" name="quantity" value="${productOrder.quantity}" type="number" class="form-control" 
                                                                   onchange="updateAction('manual')" 
                                                                   onblur="submitForm()"/>
                                                        </div>

                                                        <button data-mdb-button-init data-mdb-ripple-init class="btn btn-danger px-3 ms-2"
                                                                type="submit" name="action" value="increase" onclick="this.parentNode.querySelector('input[type=number]').stepUp()">
                        ...
                        <div class="col-md-4">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <button  type="button" data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-lg btn-block btn-danger">
                                        Xác nhận
                                    </button>
                                </div>
                            </div>
