                ...
                <div class="container-fluid py-1 px-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                            ...
                            <li class="breadcrumb-item text-sm text-dark active" aria-current="page"><a class="opacity-5 text-dark" href="managementdiscountcode">${discountCode.code}</a></li>
                        </ol>
                    </nav>
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-body container-fluid py-2">
                                            <form action="editdiscountcode" method="POST">
                                                <div class="row">
                                                    <div class="col-md-6 mb-3">
                                                        <label for="name" class="form-label"><strong>CODE</strong></label>
                                                        <input type="text" class="form-control" name="name" id="name" value="${discountCode.code}" readonly>
                                                    </div>
                                                    <div class="col-md-6 mb-3">
                                                        <label for="amount" class="form-label"><strong>Phần trăm giảm</strong></label>
                                                        <input type="number" class="form-control" name="amount" id="amount" value="${discountCode.discountPercentage}" min="1" required>
                                                    </div>
                                                    <div class="col-md-6 mb-3">
                                                        <label for="expiry" class="form-label"><strong>Ngày hết hạn</strong></label>
                                                        <input type="date" class="form-control" name="expiry" id="expiry" value="${discountCode.expiryDate}" required>
                                                    </div>
                                                    <div class="col-md-6 mb-3">
                                                        <label for="quantity" class="form-label"><strong>Số lượng</strong></label>
                                                        <input type="number" class="form-control" name="quantity" id="quantity" value="${discountCode.amount}" min="1" required>
                                                    </div>
                                                    <div class="col-md-6 mb-3">
                                                        <label for="status" class="form-label"><strong>Bật/tắt mã giảm giá</strong></label>
                                                        <select class="form-control" name="status" id="status" required>
                                                            <option value="active" ${discountCode.isActive == 'true' ? 'selected' : ''}>Bật</option>
                                                            <option value="inactive" ${discountCode.isActive == 'false' ? 'selected' : ''}>Tắt</option>
                                                        </select>
                                                    </div>
                                                </div>
