                ...
                <div class="container-fluid py-1 px-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                            ...
                            <li class="breadcrumb-item text-sm text-dark active" aria-current="page"><a class="opacity-5 text-dark" href="managementproductdetail?id=${productManager.id}">${productManager.name}</a></li>
                        </ol>
                    </nav>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="border p-3 mb-3 d-flex align-items-center justify-content-center" style="height: 300px;">
                                                <img id="previewImage" src="${productManager.image}" alt="Preview" style="max-height: 100%; max-width: 100%; object-fit: contain;"/>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <form action="updateanddeletemanagementproductdetail?pid=${productManager.id}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="input-group input-group-outline my-4">
                                                    <input type="text" class="form-control" name="id" id="id" value="${productManager.id}" placeholder="" readonly>
                                                </div>
                                                <div>
                                                    <strong>Tên sản phẩm</strong>
                                                </div>
                                                <div class="input-group input-group-outline my-4">
                                                    <input type="text" class="form-control" name="name" id="name" value="${productManager.name}" placeholder="" required>
                                                </div>
                                                <div>
                                                ...
                                                <div class="input-group input-group-outline my-4">
                                                    <input type="number" class="form-control" name="amount" id="amount" value="${productManager.amount}" placeholder="">
                                                </div>
                                                <div>
                                                ...
                                                <div class="input-group input-group-outline my-4">
                                                    <input type="text" class="form-control" name="price" id="price" 
                                                           value="<fmt:formatNumber value='${productManager.price}' type='number' pattern='#,##0'/>đ" placeholder="">
                                                </div>
                                                <div>
                                                    <strong>Tựa đề</strong>
                                                </div>
                                                <div class="input-group input-group-outline my-4">
                                                    <input type="text" class="form-control" name="title" id="title" value="${productManager.title}" placeholder="">
                                                </div>
                                                <div>
                                                    <strong>Nội dung</strong>
                                                </div>
                                                <div class="input-group input-group-outline my-4">
                                                    <input type="text" class="form-control" name="description" id="description" value="${productManager.description}" placeholder="">
                                                </div>
                                                <div>
                                                    <strong>SellID</strong>
                                                </div>
                                                <div class="input-group input-group-outline my-4">
                                                    <input type="text" class="form-control" name="sellID" id="sellID" value="${productManager.sellID}" placeholder="" readonly>
                                                </div>
