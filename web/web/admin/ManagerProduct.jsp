        ...
        <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2" id="sidenav-main">
            ...
            <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active bg-gradient-dark text-white" href="managementproduct">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card my-4">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3 d-flex align-items-center justify-content-between">
                                    ...
                                    <c:if test="${sessionScope.account.isAdmin == 1}">
                                        <a class="nav-link text-white me-3" href="#" data-bs-toggle="modal" data-bs-target="#orderEntryModal">
                            ...
                            <div class="modal fade" id="orderEntryModal" tabindex="-1" aria-labelledby="orderEntryLabel" aria-hidden="true">
                                                        ...
                                                        <div class="card-body px-0 pb-2">
                                                            <div class="container mt-5">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <form action="insertmanagementproductdetail" method="POST" enctype="multipart/form-data">
                                                                            <input type="file" id="fileInput" name="file" class="d-none" accept="image\*" onchange="previewImage(event)"/>
                                                                                ...
                                                                                <select class="form-control" name="cid" id="category">
                                                                                    <c:forEach items="${sessionScope.categorys}" var="category">
                                                                                        <option value="${category.cid}" 
                                                                                                <c:if test="${category.cname == productManager.category}">selected</c:if>>${category.cname}</option>
                                                                                    </c:forEach>
                                                                                </select>
                                                                            </div>
                                                                            <div>
                                                                            ...
                                                                            <div class="input-group input-group-outline my-1">
                                                                                <input type="number" class="form-control" name="amount" id="amount" value="" placeholder="" required>
                                                                            </div>
                                                                            <div>
                                                                            ...
                                                                            <div class="input-group input-group-outline my-1">
                                                                                <input type="text" class="form-control" name="title" id="title" value="" placeholder="" required>
                                                                            </div>
                                                                            <div>
                                                                            ...
                                                                            <div>
                                                                                <strong>SellID</strong>
                                                                            </div>
                                                                            <div class="input-group input-group-outline my-1">
                                                                                <input type="number" class="form-control" name="sellID" id="sellID" value="" placeholder="" required>
                                                                            </div>
                                                                            <br>
                                                                            <div class="d-flex justify-content-end">
                                                                                <button type="submit" class="btn btn-info me-2" name="action" value="update">Thêm sản phẩm</button>
                                    ...
                                    <table class="table align-items-center mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Nhóm hàng</th>
                                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Tình trạng</th>
                                                <th class="text-secondary opacity-7"></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <c:forEach items="${pagedProductManager}" var="productManager">
                                                <tr>
                                                    <td>
                                                        <div class="d-flex px-2 py-1">
                                                            <div>
                                                                <img src="${productManager.image}" class="avatar avatar-sm me-3 border-radius-lg" alt="user1">
                                                            </div>
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <h6 class="mb-0 text-sm">${productManager.title}</h6>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <p class="text-xs font-weight-bold mb-0">${productManager.name}</p>
                                                        <p class="text-xs text-secondary mb-0">${productManager.category}</p>
                                                    </td>
                                                    <td class="align-middle text-center text-sm">
                                                        <c:choose>
                                                            <c:when test="${productManager.amount > 0}">
                                                    ...
                                                    <td class="align-middle">
                                                        <a href="managementproductdetail?id=${productManager.id}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                                            Chi tiết
                                                        </a>
                                                    </td>
                                                </tr>
