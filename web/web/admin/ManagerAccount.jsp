        ...
        <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2" id="sidenav-main">
            ...
            <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active bg-gradient-dark text-white" href="managementaccount">
                ...
                <div class="container-fluid py-1 px-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                            ...
                            <li class="breadcrumb-item text-sm text-dark active" aria-current="page"><a class="opacity-5 text-dark" href="managementproduct">Thông tin tài khoản</a></li>
                        </ol>
                    </nav>
                            ...
                            <div class="card-body px-0 pb-2">
                                <div class="table-responsive">
                                    ...
                                    <table class="table align-items-center mb-0">
                                        <thead>
                                            <tr>
                                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-20">UID</th>
                                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-20 ps-1">Tài khoản</th>
                                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-20">Quyền Bán hàng</th>
                                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-20">Quyền Admin</th>
                                        ...
                                        <tbody>
                                            <c:forEach items="${pagedAccounts}" var="account">
                                                <tr>
                                                    <td>
                                                        <div class="align-middle text-center text-sm">
                                                            <h6 class="mb-0 text-sm">${account.id}</h6>
                                                        </div>
                                                    </td>
                                                    <td class="align-middle text-center text-sm">
                                                        <span class="text-xs font-weight-bold">${account.user}</span>
                                                    </td>
                                                    <td class="align-middle text-center text-sm">
                                                        <c:choose>
                                                            <c:when test="${account.isSell == 1}">
                                                    ...
                                                    <c:if test="${currentUserIsAdmin == 1}">
                                                        <td class="align-middle text-center text-sm">
                                                            <c:if test="${account.isAdmin == 0}">
                                                                <a class="badge badge-sm bg-gradient-danger" href="deleteaccount?uid=${account.id}">Xoá</a>
                                                            </c:if>
                                                        </td>
                                                    </c:if>
                                                </tr>
