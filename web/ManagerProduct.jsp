        ...
        <div class="container">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-6">
                            <h2 class="red-text">Manage Product</h2> <!-- Added a custom class -->
                        </div>
                        <div class="col-sm-6">
                            <a href="#addEmployeeModal" class="btn btn-red" data-toggle="modal">
            ...
            <a href="wish"><button type="button" class="btn btn-primary">Back to home</button></a>
